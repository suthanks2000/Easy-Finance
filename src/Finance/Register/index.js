...
export default function Register() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://disondys.pythonanywhere.com/userRegister",
        requestData
      );
      ...
      const uidGet = await axios.get(
        `https://PreethiJP.pythonanywhere.com/userPersonalDetail?useremail=${regData.Email}`
      );
  ...
  const handlePersonalDetail = async () => {
    ...
    try {
      const response = await axios.post(
        "https://PreethiJP.pythonanywhere.com/userPersonalDetail",
        personalData
      );
      console.log(response.data);
      alert(response.data);
            ...
            <Form onSubmit={handleCreate}>
              <div className="mt-5">
                <TextField
                  ...
                  onKeyUp={(e) =>
                    dispatch(
                      setRegisterData({ ...regData, Name: e.target.value })
                    )
                  }
                />
                {fieldErrors.Name && (
              ...
              <div className="mt-4">
                <TextField
                  ...
                  onKeyUp={(e) =>
                    dispatch(
                      setRegisterData({ ...regData, Email: e.target.value })
                    )
                  }
                />
                {fieldErrors.Email && (
