...
const InputText = (props) => {
  ...
  return (
    <div>
         ...
         <input type={props.ele.inputType} name={props.ele.inputName}  placeholder={props.inputPlaceholder} onChange={(e)=>dispatch(setPersonalInfo({...personalInfo,[e.target.name]:e.target.value}))}/>
         </div>
         )
}
